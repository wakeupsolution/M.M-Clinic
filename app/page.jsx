      ...
      icon: (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M9.75 4.5l4.5 0m-2.25 0v15m0 0a3 3 0 01-3-3v-6.75a2.25 2.25 0 00-2.25-2.25h-1.5m9 12a3 3 0 003-3v-6.75a2.25 2.25 0 012.25-2.25h1.5"
          />
        </svg>
      ),
    },
    ...
    <>
      ...
      <section className="relative w-full min-h-screen flex items-center pt-32 pb-40 overflow-hidden bg-gradient-to-br from-[#14b8a6] via-[#0d9488] to-[#0f766e] font-sans perspective-container">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="flex flex-col space-y-6 text-center lg:text-left preserve-3d">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-[56px] font-bold text-white leading-[1.1] tracking-tight drop-shadow-lg">
                Welcome to <span className="text-[#f97316]">MM CLINIC</span>{" "}
                <br />
                <span className="font-light text-white/90 text-3xl md:text-4xl mt-2 block">
        ...
        <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none z-10">
          ...
          >
            <path
              d="M0,120 L1200,120 L1200,80 C900,120 400,10 0,60 Z"
      ...
      <section className="relative bg-white py-24 lg:py-32 overflow-hidden perspective-container">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div
              className={`relative ${isVisible ? "animate-slide-left" : "opacity-0"} preserve-3d`}
            >
            ...
            <div className="flex flex-col space-y-8">
              <div
                className={`${isVisible ? "animate-reveal" : "opacity-0"} [animation-delay:200ms]`}
              >
                ...
                <p className="text-gray-600 text-lg leading-relaxed">
                  With a unique and extensive educational background spanning
                  multiple disciplines of health and law, Dr. srividhya and
                  swaminathan provides a truly integrative approach to patient
                  care. At MM Clinic, we treat the whole person, addressing the
                  root causes of illness through diverse medical knowledge.
                </p>
              </div>

              <div className="space-y-6">
                <div
                  className={`flex gap-5 transition-all duration-500 hover:translate-x-2 ${isVisible ? "animate-reveal" : "opacity-0"} [animation-delay:400ms]`}
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 leading-relaxed">
                      Expertise in Ayurveda, Homoeopathy, Pharmacy, and Yoga
                      Therapy ensures you receive the most appropriate and
                ...
                <div
                  className={`flex gap-5 transition-all duration-500 hover:translate-x-2 ${isVisible ? "animate-reveal" : "opacity-0"} [animation-delay:600ms]`}
                >
                  <div className="flex-shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 leading-relaxed">
                      Conveniently located in Uthukottai, we pride ourselves on
                      delivering ethical, patient-first medical services to our
                      neighbors.
                    </p>
                  </div>
                </div>
              ...
              <div
                className={`pt-4 border-t border-gray-100 ${isVisible ? "animate-reveal" : "opacity-0"} [animation-delay:800ms]`}
              >
                <p className="italic text-gray-400 text-sm">
                  "Healing communities through trusted knowledge and
                  compassionate care."
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-gray-500 text-base md:text-lg leading-relaxed">
              We offer a broad spectrum of medical services under one roof,
              leveraging diverse qualifications to offer the most suitable
              therapeutic pathways for you and your family.
            </p>
          </div>
      ...
      <section className="relative py-24 lg:py-32 bg-[#f4fbfb] overflow-hidden font-sans perspective-container">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none preserve-3d">
          ...
          <div className="absolute top-1/4 left-0 h-40 w-full opacity-[0.05] flex animate-ecg text-[#f97316] transform translateZ(-100px)">
            ...
            >
              <path
                d="M0,50 H200 L215,20 L240,90 L260,10 L280,70 L295,50 H500 L515,20 L540,90 L560,10 L580,70 L595,50 H800 L815,20 L840,90 L860,10 L880,70 L895,50 H1000"
                fill="none"
                stroke="currentColor"
                strokeWidth="3"
                strokeLinejoin="round"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-20 relative">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#222] mb-6 tracking-tight">
              Patient{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#14b8a6] to-[#0d9488] drop-shadow-sm">
                Programs
              </span>
            </h2>
            ...
            <p className="text-gray-500 text-base md:text-lg leading-relaxed max-w-2xl mx-auto">
              Our clinic focuses on complete wellness. We provide thorough
              diagnostic assessments and treatments across multiple branches of
              medicine.
            </p>
          </div>
                  ...
                  <ul className="space-y-2">
                    {service.items.map((item, iIndex) => (
                      <li
                        ...
                        style={{
                          animationDelay: `${mIndex * 150 + iIndex * 80}ms`,
                        }}
                      >
                        <div className="mt-0.5 relative flex-shrink-0 w-6 h-6 flex items-center justify-center">
                          ...
                          <svg
                            className="w-5 h-5 text-[#14b8a6] group-hover/item:text-[#0d9488] relative z-10 transition-colors duration-300"
                            viewBox="0 0 24 24"
                            fill="none"
                            stroke="currentColor"
                            strokeWidth="2.5"
                          ...
                          >
                            <path
                              ...
                              className="transform origin-center group-hover/item:translate-x-1 transition-transform duration-300"
                            />
                          </svg>
                        </div>
                ...
                <div className="bg-white p-6 rounded-2xl border border-teal-100 shadow-[0_10px_30px_rgba(13,148,136,0.05)] card-3d-hover">
                  <div className="pop-out-3d">
                    ...
                    <div className="flex items-start gap-4">
                      <svg
                        className="w-8 h-8 text-orange-500 mt-1 flex-shrink-0"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                        strokeWidth="1.5"
                  ...
                  <div className="pop-out-3d">
                    ...
                    <ul className="space-y-4">
                      <li className="flex items-center gap-4">
                        ...
                        <a
                          href="tel:+919444796479"
                          className="text-gray-800 font-bold hover:text-teal-600 transition-colors"
                        >
                          +91 94447 96479
                        </a>
                      </li>
              ...
              <div className="relative z-10 w-full max-w-md bg-white rounded-3xl shadow-2xl border border-gray-100 p-8 text-center animate-float-3d card-3d-hover flex flex-col items-center">
                <div className="pop-out-3d w-full flex flex-col items-center">
                  ...
                  <p className="text-gray-500 mb-6">
                    Healing with Care & Expertise
                  </p>
                  <a
                    href="tel:+919444796479"
                    className="w-full block bg-orange-500 text-white py-3 rounded-lg font-bold shadow-[0_8px_20px_rgba(249,115,22,0.3)] hover:bg-orange-600 transition-colors"
                  >
                    Book an Appointment
                  </a>
                </div>
